...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <!-- Nav Item - Pages Collapse Menu -->
    <li class="nav-item {{ (request()->segment(2) == 'highlights') ? 'active' : '' }}">
      <a class="nav-link " href="{{route('admin.highlights')}}" >
        <i class="fas fa-fw fa-columns"></i>
    ...
    <li class="nav-item {{ (request()->segment(2) == 'photo') ? 'active' : '' }}">
      <a class="nav-link " href="{{route('admin.photo')}}">
        <i class="fas fa-fw fa-newspaper"></i>
        <span>Photo</span>
      </a>
    </li>
    ...
    <!-- Nav Item - Utilities Collapse Menu -->
    <li class="nav-item {{ (request()->segment(2) == 'tv') ? 'active' : '' }}">
      <a class="nav-link " href="{{route('admin.tv')}}">
        <i class="fas fa-fw fa-newspaper"></i>
        <span>TV</span>
      </a>
    </li>
    <!-- Nav Item - Utilities Collapse Menu -->
    <li class="nav-item {{ (request()->segment(2) == 'achievement') ? 'active' : '' }}">
    ...
    <!-- Nav Item - Utilities Collapse Menu -->
    <li class="nav-item {{ (request()->segment(2) == 'wheretobuy') ? 'active' : '' }}">
      <a class="nav-link " href="{{route('admin.wheretobuy')}}">
